...
fn test_to_from_identity_random_fen() {
    ...
    let mut cboard = chessboard::Chessboard::from_fen(FEN1, " ");
...
fn test_to_from_identity_en_passant_white_fen() {
    ...
    let mut cboard = chessboard::Chessboard::from_fen(FEN2, " ");
...
fn test_to_from_identity_en_passant_black_fen() {
    ...
    let mut cboard = chessboard::Chessboard::from_fen(FEN3, " ");
